...
Scheme
{
	...
	Colors
	{
		...
		"BrightControlText"	"198 182 82 255"	// use for selected controls
		"DisabledText1"		"255 255 255 255"	// disabled text
		"DisabledText2"		"255 255 255 48"	// overlay color for disabled text (to give that inset look)
		...
		"SelectionBG"		"150 137 49 255"	    // background color of any selected text or menu item
		...
		// border colors
		"BorderBright"		"133 145 125 255"	// the lit side of a control
		"BorderDark"		"38 47 28 255"		// the dark/unlit side of a control
